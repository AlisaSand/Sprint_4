...
class ImportantQuestionLocator:
...
class ImportantQuestionActions(BasePage):
    def get_on_questions_section(self):
        self.click_accept_cookies()
        element = self.find_element(ImportantQuestionLocator.QUESTION_ABOUT_PAYMENT)
        self.driver.execute_script("arguments[0].scrollIntoView();", element)

    def click_accept_cookies(self):
        self.click_on_element(ImportantQuestionLocator.BUTTON_TO_ACCEPT_COOKIES)

    def click_on_question_about_payment(self):
        self.click_on_element(ImportantQuestionLocator.QUESTION_ABOUT_PAYMENT)

    def click_on_question_about_quantity_of_scooters(self):
        self.click_on_element(ImportantQuestionLocator.QUESTION_ABOUT_QUANTITY_OF_SCOOTER)

    def click_on_question_about_time_of_using(self):
        self.click_on_element(ImportantQuestionLocator.QUESTION_ABOUT_TIME_OF_USING)

    def click_on_question_about_order_today(self):
        self.click_on_element(ImportantQuestionLocator.QUESTION_ABOUT_ORDER_TODAY)

    def click_on_question_about_returning_of_scooter(self):
        self.click_on_element(ImportantQuestionLocator.QUESTION_ABOUT_RETURNING_OF_SCOOTER)

    def click_on_question_about_scooter_charging(self):
        self.click_on_element(ImportantQuestionLocator.QUESTION_ABOUT_SCOOTER_CHARGING)

    def click_on_question_about_order_cancellation(self):
        self.click_on_element(ImportantQuestionLocator.QUESTION_ABOUT_ORDER_CANCELLATION)

    def click_on_question_about_long_distance_shipment(self):
        self.click_on_element(ImportantQuestionLocator.QUESTION_ABOUT_LONG_DISTANCE_SHIPMENT)

    def check_answer_on_payment_question(self):
        self.get_on_questions_section()
        self.click_on_question_about_payment()
        actual_result = self.find_element(ImportantQuestionLocator.ANSWER_ABOUT_PAYMENT).text
    ...
    def check_answer_on_question_about_quantity_of_scooters(self):
        ...
        actual_result = self.find_element(ImportantQuestionLocator.ANSWER_ABOUT_QUANTITY_OF_SCOOTERS).text
    ...
    def check_answer_on_question_about_time_of_using(self):
        ...
        actual_result = self.find_element(ImportantQuestionLocator.ANSWER_ABOUT_TIME_OF_USING).text
    ...
    def check_answer_about_order_today(self):
        ...
        actual_result = self.find_element(ImportantQuestionLocator.ANSWER_ABOUT_ORDER_TODAY).text
    ...
    def check_answer_about_returning_of_scooter(self):
        ...
        actual_result = self.find_element(ImportantQuestionLocator.ANSWER_ABOUT_RETURNING_OF_SCOOTER).text
    ...
    def check_answer_about_scooter_charging(self):
        ...
        actual_result = self.find_element(ImportantQuestionLocator.ANSWER_ABOUT_SCOOTER_CHARGING).text
    ...
    def check_answer_about_order_cancellation(self):
        ...
        actual_result = self.find_element(ImportantQuestionLocator.ANSWER_ABOUT_ORDER_CANCELLATION).text
    ...
    def check_answer_about_long_distance_shipment(self):
        ...
        actual_result = self.find_element(ImportantQuestionLocator.ANSWER_ABOUT_LONG_DISTANCE_SHIPMENT).text
